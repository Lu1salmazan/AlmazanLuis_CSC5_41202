...
int main(int argc, char** argv) {
    ...
    do{
        int ply=1;//set player turn for dies role
            switch (ply){
            case 1:pl1HVS();ply++;break;
            case 2:pl2HVS();ply++;break;
            case 3:pl3HVS();ply++;break;
            case 4:pl4HVS();ply=1;break;}
    }while(win!=*home);
    cout<<"won"<<endl;
    return 0;
}
...
void pl1HVS(){
    ...
    while (plyRD1==0&&plyRD2==0&&plyRD3==0&&plyRD4==0){
        ...
        if (die==1){//check for pons at home and start
            ...
            (plyRD4!=rdHM&&plyRD4==0?plyRD4=1:'1'))));
        }else if(die==6){
            (plyRD1!=rdHM&&plyRD1==0?plyRD1=1:
            (plyRD2!=rdHM&&plyRD2==0?plyRD2=1:
            (plyRD3!=rdHM&&plyRD3==0?plyRD3=1:
            ...
            (plyRD4!=rdHM&&plyRD4!=0&&(plyRD4=plyRD4+die)<rdHM?plyRD4=plyRD4+die:'0'))));
            }while(die==6);
        }else cout<<endl;
    }
    do{die=rand()%6+1;
...
void pl2HVS(){
    ...
    while (plyBL1==0&&plyBL2==0&&plyBL3==0&&plyBL4==0){
        ...
        if (die==1){
            ...
            (plyBL4!=blHM&&plyBL4==0?plyBL4=1:'1'))));
            ...
            (plyBL4!=blHM&&plyBL4!=0&&(plyBL4=plyBL4+die)<blHM?plyBL4=plyBL4+die:'0'))));
            }while(die==6);
        }else cout<<endl;
    }
    do{die=rand()%6+1;
...
void pl3HVS(){
    ...
    while (plyGR1==0&&plyGR2==0&&plyGR3==0&&plyGR4==0){
        ...
        if (die==1){
            ...
            (plyGR4!=grHM&&plyGR4==0?plyGR4=1:'1'))));
            //Check for pons at home and at start
        }else if(die==6){
            (plyGR1!=grHM&&plyGR1==0?plyGR1=1:
            (plyGR2!=grHM&&plyGR2==0?plyGR2=1:
            ...
            (plyGR4!=grHM&&plyGR4!=0&&(plyGR4=plyGR4+die)<grHM?plyGR4=plyGR4+die:'0'))));
            }while(die==6);
        }else cout<<endl;                    
    }
    do{die=rand()%6+1;
...
void pl4HVS(){
    ...
    //getting out from starting point
        if (die==1){
            ...
            (plyYL4!=ylHM&&plyYL4==0?plyYL4=1:'1'))));
            //Check for pons at home and at start
        }else if(die==6){
            (plyYL1!=ylHM&&plyYL1==0?plyYL1=1:
            (plyYL2!=ylHM&&plyYL2==0?plyYL2=1:
            ...
            (plyYL4!=ylHM&&plyYL4!=0&&(plyYL4=plyYL4+die)<ylHM?plyYL4=plyYL4+die:'0'))));
            }while(die==6);
        }else cout<<endl;
    }
    do{die=rand()%6+1;
